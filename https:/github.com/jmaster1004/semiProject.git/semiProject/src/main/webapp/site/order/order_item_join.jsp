 ...
 */		
	...
	String buyItemName = request.getParameter("buy_ItemName");
	String buyItemEach = request.getParameter("buy_ItemEach");
	
	int buyItemNumber = Integer.parseInt(buyItemCD);
	
	ItemDTO item = ItemDAO.getDAO().selectNumItem(buyItemNumber); 
	int total = item.getItemPrice() * Integer.parseInt(buyItemEach);
...
<form name="order_joinForm" id="order_joinForm" action="<%=request.getContextPath() %>/site/index.jsp?workgroup=order&work=order_insert_action" method="post">
	...
	<input type="hidden" name ="buy_ItemCD" value="<%=buyItemCD%>">
	<input type="hidden" name ="buy_ItemEach" value="<%=buyItemEach%>">
                ...
                <div class="orderArea ">
                    ...
                    <div class="xans-element- xans-order xans-order-supplierlist">
                        <div class="ec-base-prdInfo xans-record-">
                            <div class="prdBox">
                                <div class="thumbnail"><a href=""><img src="<%=request.getContextPath() %>/site/item_image/<%=item.getItemMainImage() %>" alt="<%= item.getItemMainImage() %>" width="90" height="90"></a></div>
                                <div class="description">
                                    <strong class="prdName" title="상품명"> <a href="" class="ec-product-name"><%= item.getItemNm() %></a></strong>
                                    <ul class="info">
                                        <li>수량: <%= buyItemEach %>개</li>
                                        <li>
                                            <span id="">상품구매금액: ₩<%= total %> </span>
