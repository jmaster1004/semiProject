...
<%
	...
	int totalQa=QaDAO.getDAO().selectQaCount(search, keyword, loginMember.getMemberEmail());
	...
	List<QaDTO> qaList=QaDAO.getDAO().selectAllList(startRow, endRow, search, keyword, loginMember.getMemberEmail());
	...
	session.setAttribute("postURL", requestURI+queryString);
	...
	<div class="site-wrap">
		...
		<div
			...
			<div
				...
				<div class="titleArea">
					<h2>				
						<font color="333333">내가 쓴 상품 Q&amp;A</font>
					</h2>
					<p>내가 쓴 상품 Q&amp;A입니다.</p>
				</div>
				<p class="imgArea"></p>
